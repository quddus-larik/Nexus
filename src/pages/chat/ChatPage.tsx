            ...
            <div className="flex h-[65vh] items-center justify-center bg-gradient-to-br from-slate-950 via-slate-900 to-slate-800 p-8 text-white">
              <div className="max-w-md text-center">
                ...
                <div className="mt-8 flex items-center justify-center gap-2 text-white/60">
                  ...
                  <span className="h-3 w-3 animate-pulse rounded-full bg-white/40" style={{ animationDelay: '0.15s' }} />
                  <span className="h-3 w-3 animate-pulse rounded-full bg-white/20" style={{ animationDelay: '0.3s' }} />
                </div>
              </div>
